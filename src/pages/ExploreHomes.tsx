...
export default function ExploreHomes() {
    ...
    const [activeGallery, setActiveGallery] = useState<HomeProject[]>(PROJECTS);

    const openLightbox = (project: HomeProject, index: number, gallery: HomeProject[]) => {
                ...
                >
                    {PROJECTS.map((project, index) => (
                        <motion.div
                            ...
                            onClick={() => openLightbox(project, index, PROJECTS)}
            ...
            <section className="wb-container pb-20">
                <div className="mb-10 text-center">
                    ...
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.75, ease: EASE, delay: 0.1 }}
                        className="wb-serif mt-4 text-[28px] leading-[1.1] sm:text-[40px] lg:text-[48px] text-(--wb-ink)"
                    >
                        Stunning Interiors
                    </motion.h2>
                    ...
                    <motion.p
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.65, ease: EASE, delay: 0.2 }}
                        className="mt-4 text-[15px] sm:text-[17px] leading-relaxed text-(--wb-ink)/70 max-w-[55ch] mx-auto"
                    >
                        Experience the elegance of our interior designs, crafted to create
                        spaces that feel both luxurious and inviting.
                    </motion.p>
                </div>
                ...
                >
                    {INTERIORS.map((interior, index) => (
                        <motion.div
                            ...
                            whileHover={{ y: -8, scale: 1.02 }}
                            transition={{ duration: 0.4, ease: EASE }}
                            onClick={() => openLightbox(interior, index, INTERIORS)}
                            className="group relative cursor-pointer overflow-hidden rounded-2xl sm:rounded-3xl
                shadow-[0_18px_55px_rgba(12,24,48,0.12)]
                hover:shadow-[0_38px_120px_rgba(12,24,48,0.22)]
                transition-shadow duration-500"
